...
try:
    ...
    print("Connection to MongoDB established in users_endpoints.py")
except Exception as e:
    print(f"Error connecting to MongoDB in users_endpoints.py: {e}")
...
async def create_new_user(user_data: UserCreate = Body(...)):
    ...
    """
    try:
        # Appel à la fonction create_user_endpoint
