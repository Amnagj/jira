...
def connect_to_mongodb():
    ...
    try:
        ...
        # Vérifier la connexion en forçant une communication avec le serveur
        client.server_info()
        ...
        # En développement, vous pouvez vouloir continuer malgré l'erreur
        # Mais en production, il vaut mieux lever l'exception
        raise
...
def send_email(recipient_email, username, password):
    ...
    try:
        ...
        print(f"[SIMULATION EMAIL] Sujet: Vos identifiants de connexion à VermegSupport")
        ...
        msg["Subject"] = "Vos identifiants de connexion à Ticket AI de Vermeg"
        ...
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            <div style="background-color: #f3f4f6; padding: 15px; border-radius: 5px; margin: 20px 0;">
                ...
                <p><strong>Lien de connexion :</strong> <a href="http://localhost:8080/login" style="color: #4F46E5;">Cliquez ici pour vous connecter</a></p>
            </div>
            <p>Si vous avez des questions, n'hésitez pas à contacter l'administrateur.</p>
            <p>Cordialement,<br />L'équipe VermegSupport</p>
        </div>
